...
kg/kschedule/2.0.0/scheduleform
kg/kschedule/2.0.0/index

*/
KISSY.add('kg/kschedule/2.0.0/scheduleform',function(S, Node, Base){
 ...
 * @module kschedule
 **/
KISSY.add('kg/kschedule/2.0.0/index',function (S, Node, Base, Sizzle, Xtpl, SF) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     * kissy日程组件
    ...
    function Kschedule(cfg) {
        ...
        self.timer = null;
        self.set("days", 7);
        self.set("msDay", 24 * 60 * 60 * 2.0.00);
